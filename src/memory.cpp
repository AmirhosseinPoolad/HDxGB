...
private:
    ...
    //0x4000 to 0x7FFF --- 16 KiB, mapped to cartridge ROM. The bank number can be changed by the Memory Bank Controller
    uint8_t *ccartridgeRomBank_nn;
